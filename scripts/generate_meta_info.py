...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input',
        nargs='+',
        default=['/home/be205_18/Real-ESRGAN-master/hr/train/male','/home/be205_18/Real-ESRGAN-master/hr/train/female'],
        help='Input folder, can be a list')
    parser.add_argument(
        '--root',
        nargs='+',
        default=['home/be205_18/Real-ESRGAN-master/hr/train', 'home/be205_18/Real-ESRGAN-master/hr/train'],
        help='Folder root, should have the length as input folders')
    parser.add_argument(
        '--meta_info',
        type=str,
        default='/home/be205_18/Real-ESRGAN-master/hr/train/meta_info.txt',
